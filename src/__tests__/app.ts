...
test('fix blurry images', async (t) => {
  const options = {
    ...
    to: `$1if(n.width>3272){e.height=Math.floor(3272*n.height/n.width);e.width=3272;}else{e.width=n.width;e.height=n.height;}document.dispatchEvent(new CustomEvent("ping", { detail: { type: "toast", msg: "higher resolution captured ✅" } }));$2`,
  }
